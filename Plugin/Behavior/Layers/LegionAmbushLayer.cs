...
{
    internal class LegionAmbushLayer : CustomLayer
    {
        private LegionGroupManager _manager;
        private Type _nextAction;
        private Type _lastAction;

        public LegionAmbushLayer(BotOwner botOwner, int priority)
        ...
        public override bool IsActive()
        {
            ...
            if (_manager.NearbyUndetectedPMC == null)
            {
                return false;
            }
            ...
            _nextAction = typeof(LegionAmbushHoldAction);
            return true;
        }
